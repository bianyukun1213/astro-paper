 ...
 *
 * Generated at: 2026-04-15T04:53:39.156Z
 *
...
import type { Tailwind, DefaultTheme } from './types';

import { createSpacingHelper } from 'tailwind-resolver/v4/shared/spacing_helper';
...
const variantsData = {
  "default": {
    ...
    "defaults": {
      ...
      "fontFamily": "--theme(--font-sans, initial)",
      "fontFeatureSettings": "--theme(--font-sans--font-feature-settings, initial)",
      "fontVariationSettings": "--theme(--font-sans--font-variation-settings, initial)",
      "monoFontFamily": "--theme(--font-mono, initial)",
      "monoFontFeatureSettings": "--theme(--font-mono--font-feature-settings, initial)",
      "monoFontVariationSettings": "--theme(--font-mono--font-variation-settings, initial)"
    },
    "keyframes": {
...
// Wrap spacing properties with callable helpers
const defaultSpacingBase = "0.25rem";

if (variantsData.default.spacing) {
  variantsData.default.spacing = createSpacingHelper(variantsData.default.spacing, defaultSpacingBase);
}

if (variantsData.dark?.spacing) {
  variantsData.dark.spacing = createSpacingHelper(variantsData.dark.spacing, defaultSpacingBase);
}

export const variants = variantsData as Tailwind['variants'];

/**
 * CSS selectors for each theme variant
 */
...
/**
 * Master Tailwind object matching resolveTheme() structure
 * Use this for full compatibility with runtime API
 */
